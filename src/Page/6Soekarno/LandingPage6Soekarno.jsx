...
const LandingPage6Soekarno = () => {
  ...
  const menuItems = [
    { 
      ...
      path: '/6-soekarno/jadwal',
      description: 'Lihat jadwal pelajaran harian dan mingguan Kelas 6 Soekarno'
    },
    { 
      id: 'mata-pelajaran', 
      icon: BookOpen, 
      ...
      path: '/6-soekarno/mata-pelajaran',
          ...
          <div className="flex justify-between items-center h-20">
            <Link to="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
              <div className="relative">
                <div className="p-2 bg-gradient-to-r from-red-600 to-blue-600 rounded-xl">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              >
                ...
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-red-600 to-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </Link>
              {menuItems.map((item) => (
                <Link
                  key={item.id}
      ...
      <div className="relative min-h-screen flex items-center justify-center pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            {/* Badge */}
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-red-100 to-blue-100 rounded-full text-red-700 text-sm font-medium mb-6">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-gray-700 mb-6 leading-tight">
              Selamat Datang di
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-blue-600 to-yellow-600 animate-gradient">
                Kelas 6 Soekarno
              </span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-500 max-w-3xl mx-auto mb-10 leading-relaxed">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-blue-600 font-semibold"> pemimpin masa depan bangsa</span>
            </p>

            {/* Tombol Menu Utama */}
            <button
              onClick={scrollToMenu}
              className="group relative inline-flex items-center space-x-3 px-10 py-5 bg-gradient-to-r from-red-600 to-blue-600 text-white rounded-full font-semibold text-lg transition-all duration-300 hover:shadow-2xl hover:shadow-red-500/25 hover:-translate-y-1"
            >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-700 mb-4">
              Menu <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-blue-600">Utama</span>
            </h2>
            <p className="text-gray-400 text-lg">Akses fitur-fitur penting Kelas 6 Soekarno</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              ...
              <span className="text-gray-600 font-medium">Kelas 6 Soekarno</span>
            </div>
...
export default LandingPage6Soekarno;