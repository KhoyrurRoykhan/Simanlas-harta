    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (querySnapshot.empty) {
          setError('Data SBdP untuk Kelas 3 Dewi Sartika tidak ditemukan');
          setIsLoading(false);
          return;
        }
        ...
        setData({
          mapel: {
            ...
            deskripsi: mapelData.deskripsi || 'Seni Budaya dan Prakarya - Mengembangkan kreativitas dan apresiasi seni',
            icon: mapelData.icon || '🎨',
