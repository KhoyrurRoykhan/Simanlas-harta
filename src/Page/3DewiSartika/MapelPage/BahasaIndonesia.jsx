    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (querySnapshot.empty) {
          setError('Data Bahasa Indonesia untuk Kelas 3 Dewi Sartika tidak ditemukan');
          setIsLoading(false);
          return;
        }
        ...
        console.log('📝 Data Bahasa Indonesia:', {
          nama: mapelData.nama,
        ...
        setData({
          mapel: {
            ...
            deskripsi: mapelData.deskripsi || 'Mengembangkan kemampuan berbahasa dan bersastra Indonesia',
            icon: mapelData.icon || '📚',
