...
const Ipas = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (querySnapshot.empty) {
          setError('Data IPAS untuk Kelas 3 Dewi Sartika tidak ditemukan');
          setIsLoading(false);
          return;
        }
        ...
        setData({
          mapel: {
            ...
            deskripsi: mapelData.deskripsi || 'Ilmu Pengetahuan Alam dan Sosial - Memahami alam dan lingkungan sosial',
            icon: mapelData.icon || '🔬',
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cyan-50 via-teal-50 to-emerald-50 p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-teal-500 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-300"
          >
            Coba Lagi
          </button>
        </div>
