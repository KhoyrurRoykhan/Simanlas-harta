// src/pages/PendidikanPancasila.jsx
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (querySnapshot.empty) {
          setError('Data Pendidikan Pancasila untuk Kelas 3 Dewi Sartika tidak ditemukan');
          setIsLoading(false);
          return;
        }
        ...
        console.log('📝 Data Pendidikan Pancasila:', {
          nama: mapelData.nama,
        ...
        setData({
          mapel: {
            ...
            deskripsi: mapelData.deskripsi || 'Mempelajari nilai-nilai Pancasila dan karakter kebangsaan',
            icon: mapelData.icon || '🛡️',
            totalPertemuan: pertemuanList.length,
            pertemuan: pertemuanList,
            createdBy: mapelData.createdBy || 'Wali Kelas',
            kelas: mapelData.kelas || '3_dewi_sartika',
            namaKelas: mapelData.namaKelas || 'Kelas 3 Dewi Sartika'
          }
        });
