...
const BahasaInggris = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (querySnapshot.empty) {
          setError('Data Bahasa Inggris untuk Kelas 3 Dewi Sartika tidak ditemukan');
          setIsLoading(false);
          return;
        }
        ...
        console.log('📝 Data Bahasa Inggris:', {
          nama: mapelData.nama,
        ...
        setData({
          mapel: {
            ...
            deskripsi: mapelData.deskripsi || 'Mempelajari bahasa Inggris dasar untuk komunikasi sehari-hari',
            icon: mapelData.icon || '🌍',
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-cyan-50 to-sky-50 p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-300"
          >
            Coba Lagi
          </button>
        </div>
