    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (querySnapshot.empty) {
          setError('Data PJOK untuk Kelas 3 RA Kartini tidak ditemukan');
          setIsLoading(false);
          return;
        }
        ...
        console.log('📝 Data PJOK RA Kartini:', {
          nama: mapelData.nama,
        ...
        setData({
          mapel: {
            ...
            deskripsi: mapelData.deskripsi || 'Mempelajari aktivitas jasmani, olahraga, dan kesehatan untuk mengembangkan kebugaran, keterampilan gerak, dan pola hidup sehat',
            icon: mapelData.icon || '🏃',
      ...
      return (
        <div className="text-center py-16">
          <div className="inline-flex p-6 bg-lime-100 rounded-full mb-4">
            <Activity className="w-16 h-16 text-lime-500" />
          </div>
