    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (querySnapshot.empty) {
          setError('Data Agama untuk Kelas 3 RA Kartini tidak ditemukan');
          setIsLoading(false);
          return;
        }
        ...
        console.log('📝 Data Agama RA Kartini:', {
          nama: mapelData.nama,
        ...
        setData({
          mapel: {
            id: mapelId,
            nama: mapelData.nama || 'Agama',
            deskripsi: mapelData.deskripsi || 'Pendidikan Agama Islam - Mempelajari ajaran Islam dan akhlak mulia',
            icon: mapelData.icon || '🕌',
                ...
                <div className="p-4 space-y-4">
                  ...
                  {pertemuan.materi && (
                    <div className="bg-emerald-50 rounded-lg p-4 border border-emerald-200">
                      ...
                      <p className="text-emerald-700 whitespace-pre-wrap">{pertemuan.materi}</p>
                    </div>
                  )}
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50">
        <div className="text-center">
          <Loader className="w-16 h-16 animate-spin text-emerald-500 mx-auto mb-4" />
          <p className="text-gray-500">Memuat data Agama...</p>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-emerald-500 to-green-500 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-300"
          >
            Coba Lagi
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50">
          ...
          <div className="flex justify-between items-center h-20">
            <Link to="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
              ...
              <div>
                ...
                <span className="block text-xs text-emerald-600 font-medium">{data.mapel.namaKelas}</span>
              </div>
            </Link>
            <div className="flex items-center space-x-4">
              <Link 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-12 text-center text-gray-400 text-sm">
          <p>© 2026 Agama - {data.mapel.namaKelas}</p>
...
export default Agama3RaKartini;