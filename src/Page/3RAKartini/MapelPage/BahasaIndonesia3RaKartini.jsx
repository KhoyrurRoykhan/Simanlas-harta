// src/pages/BahasaIndonesia3RaKartini.jsx
...
const BahasaIndonesia3RaKartini = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (querySnapshot.empty) {
          setError('Data Bahasa Indonesia untuk Kelas 3 RA Kartini tidak ditemukan');
          setIsLoading(false);
          return;
        }
        ...
        console.log('📝 Data Bahasa Indonesia RA Kartini:', {
          nama: mapelData.nama,
        ...
        setData({
          mapel: {
            id: mapelId,
            nama: mapelData.nama || 'Bahasa Indonesia',
            deskripsi: mapelData.deskripsi || 'Mempelajari keterampilan berbahasa Indonesia yang baik dan benar, meliputi membaca, menulis, berbicara, dan mendengarkan',
            icon: mapelData.icon || '📚',
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-cyan-50 to-sky-50">
        <div className="text-center">
          ...
          <p className="text-gray-500">Memuat data Bahasa Indonesia...</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-sky-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-12 text-center text-gray-400 text-sm">
          <p>© 2026 Bahasa Indonesia - {data.mapel.namaKelas}</p>
...
export default BahasaIndonesia3RaKartini;