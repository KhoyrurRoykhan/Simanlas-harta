    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (querySnapshot.empty) {
          setError('Data PLKS untuk Kelas 3 RA Kartini tidak ditemukan');
          setIsLoading(false);
          return;
        }
        ...
        console.log('📝 Data PLKS RA Kartini:', {
          nama: mapelData.nama,
        ...
        setData({
          mapel: {
            ...
            deskripsi: mapelData.deskripsi || 'Mempelajari tentang lingkungan hidup, kebersihan, kesehatan, dan kepedulian terhadap lingkungan sekitar',
