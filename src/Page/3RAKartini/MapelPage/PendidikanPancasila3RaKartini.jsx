// src/pages/PendidikanPancasila3RaKartini.jsx
...
const PendidikanPancasila3RaKartini = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const q = query(
          mapelRef,
          where('nama', '==', 'Pendidikan Pancasila'),
        ...
        if (querySnapshot.empty) {
          setError('Data Pendidikan Pancasila untuk Kelas 3 RA Kartini tidak ditemukan');
          setIsLoading(false);
          return;
        }
        ...
        console.log('📝 Data Pendidikan Pancasila RA Kartini:', {
          nama: mapelData.nama,
        ...
        setData({
          mapel: {
            id: mapelId,
            nama: mapelData.nama || 'Pendidikan Pancasila',
            deskripsi: mapelData.deskripsi || 'Mempelajari nilai-nilai Pancasila, budi pekerti, dan kewarganegaraan untuk membentuk karakter yang baik dan cinta tanah air',
                ...
                <div className="p-4 space-y-4">
                  ...
                  {pertemuan.materi && (
                    <div className="bg-orange-50 rounded-lg p-4 border border-orange-200">
                      ...
                      <p className="text-orange-700 whitespace-pre-wrap">{pertemuan.materi}</p>
                    </div>
                  )}
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
        <div className="text-center">
          ...
          <p className="text-gray-500">Memuat data Pendidikan Pancasila...</p>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-300"
          >
            Coba Lagi
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
          ...
          <div className="flex justify-between items-center h-20">
            <Link to="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
              ...
              <div>
                ...
                <span className="block text-xs text-orange-600 font-medium">{data.mapel.namaKelas}</span>
              </div>
            </Link>
            <div className="flex items-center space-x-4">
              <Link 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Pertemuan List */}
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-orange-100 p-6 shadow-lg">
        ...
        <div className="mt-12 text-center text-gray-400 text-sm">
          <p>© 2026 Pendidikan Pancasila - {data.mapel.namaKelas}</p>
...
export default PendidikanPancasila3RaKartini;