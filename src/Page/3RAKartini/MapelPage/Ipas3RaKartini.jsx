...
const Ipas3RaKartini = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (querySnapshot.empty) {
          setError('Data IPAS untuk Kelas 3 RA Kartini tidak ditemukan');
          setIsLoading(false);
          return;
        }
        ...
        console.log('📝 Data IPAS RA Kartini:', {
          nama: mapelData.nama,
        ...
        setData({
          mapel: {
            id: mapelId,
            nama: mapelData.nama || 'IPAS',
            deskripsi: mapelData.deskripsi || 'Mempelajari ilmu pengetahuan alam dan sosial, meliputi makhluk hidup, lingkungan, benda-benda di sekitar, dan interaksi sosial',
            icon: mapelData.icon || '🔬',
        ...
        {pertemuanList.map((pertemuan) => {
          ...
          return (
            <div key={pertemuan.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
              {/* Header Pertemuan */}
              <div 
                className="flex items-center justify-between p-4 bg-gradient-to-r from-cyan-50 to-sky-50 cursor-pointer hover:from-cyan-100 hover:to-sky-100 transition-colors"
                ...
                <div className="p-4 space-y-4">
                  ...
                  {pertemuan.materi && (
                    <div className="bg-cyan-50 rounded-lg p-4 border border-cyan-200">
                      ...
                      <p className="text-cyan-700 whitespace-pre-wrap">{pertemuan.materi}</p>
                    </div>
                  )}
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cyan-50 via-sky-50 to-blue-50">
        <div className="text-center">
          <Loader className="w-16 h-16 animate-spin text-cyan-500 mx-auto mb-4" />
          <p className="text-gray-500">Memuat data IPAS...</p>
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cyan-50 via-sky-50 to-blue-50 p-4">
    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-sky-50 to-blue-50">
          ...
          <div className="flex justify-between items-center h-20">
            <Link to="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
              ...
              <div>
                ...
                <span className="block text-xs text-cyan-600 font-medium">{data.mapel.namaKelas}</span>
              </div>
            </Link>
            <div className="flex items-center space-x-4">
              <Link 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-12 text-center text-gray-400 text-sm">
          <p>© 2026 IPAS - {data.mapel.namaKelas}</p>
