...
const Sbdp3RaKartini = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (querySnapshot.empty) {
          setError('Data SBdP untuk Kelas 3 RA Kartini tidak ditemukan');
          setIsLoading(false);
          return;
        }
        ...
        console.log('📝 Data SBdP RA Kartini:', {
          nama: mapelData.nama,
        ...
        setData({
          mapel: {
            id: mapelId,
            nama: mapelData.nama || 'SBdP',
            deskripsi: mapelData.deskripsi || 'Mempelajari seni budaya dan prakarya, meliputi seni rupa, seni musik, seni tari, dan keterampilan membuat karya',
            icon: mapelData.icon || '🎨',
        ...
        {pertemuanList.map((pertemuan) => {
          ...
          return (
            <div key={pertemuan.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
              {/* Header Pertemuan */}
              <div 
                className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-violet-50 cursor-pointer hover:from-purple-100 hover:to-violet-100 transition-colors"
                ...
                <div className="p-4 space-y-4">
                  ...
                  {pertemuan.materi && (
                    <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                      ...
                      <p className="text-purple-700 whitespace-pre-wrap">{pertemuan.materi}</p>
                    </div>
                  )}
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-violet-50 to-indigo-50">
        <div className="text-center">
          ...
          <p className="text-gray-500">Memuat data SBdP...</p>
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-violet-50 to-indigo-50 p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-purple-500 to-violet-500 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-300"
          >
            Coba Lagi
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-violet-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center h-20">
            <Link to="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
              ...
              <div>
                ...
                <span className="block text-xs text-purple-600 font-medium">{data.mapel.namaKelas}</span>
              </div>
            </Link>
            <div className="flex items-center space-x-4">
              <Link 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-12 text-center text-gray-400 text-sm">
          <p>© 2026 SBdP - {data.mapel.namaKelas}</p>
