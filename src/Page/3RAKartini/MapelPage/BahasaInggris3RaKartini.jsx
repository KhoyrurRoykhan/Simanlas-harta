// src/pages/BahasaInggris3RaKartini.jsx
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (querySnapshot.empty) {
          setError('Data Bahasa Inggris untuk Kelas 3 RA Kartini tidak ditemukan');
          setIsLoading(false);
          return;
        }
        ...
        console.log('📝 Data Bahasa Inggris RA Kartini:', {
          nama: mapelData.nama,
        ...
        setData({
          mapel: {
            id: mapelId,
            nama: mapelData.nama || 'Bahasa Inggris',
            deskripsi: mapelData.deskripsi || 'Mempelajari bahasa Inggris dasar, meliputi kosakata, percakapan sederhana, dan pengenalan tata bahasa dasar',
            icon: mapelData.icon || '🌍',
        ...
        {pertemuanList.map((pertemuan) => {
          ...
          return (
            <div key={pertemuan.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
              {/* Header Pertemuan */}
              <div 
                className="flex items-center justify-between p-4 bg-gradient-to-r from-red-50 to-rose-50 cursor-pointer hover:from-red-100 hover:to-rose-100 transition-colors"
                ...
                <div className="p-4 space-y-4">
                  ...
                  {pertemuan.materi && (
                    <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                      ...
                      <p className="text-red-700 whitespace-pre-wrap">{pertemuan.materi}</p>
                    </div>
                  )}
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 via-rose-50 to-pink-50">
        <div className="text-center">
          <Loader className="w-16 h-16 animate-spin text-red-500 mx-auto mb-4" />
          <p className="text-gray-500">Memuat data Bahasa Inggris...</p>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 via-rose-50 to-pink-50 p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-red-500 to-rose-500 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-300"
          >
            Coba Lagi
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-rose-50 to-pink-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <Link to="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
              ...
              <div>
                <span className="text-xl font-bold text-gray-700">Bahasa Inggris</span>
                <span className="block text-xs text-red-600 font-medium">{data.mapel.namaKelas}</span>
              </div>
            </Link>
            <div className="flex items-center space-x-4">
              <Link 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Pertemuan List */}
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-red-100 p-6 shadow-lg">
        ...
        <div className="mt-12 text-center text-gray-400 text-sm">
          <p>© 2026 Bahasa Inggris - {data.mapel.namaKelas}</p>
...
export default BahasaInggris3RaKartini;