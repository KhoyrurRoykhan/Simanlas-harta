...
const LandingPage1PDiponegoro = () => {
  ...
  const menuItems = [
    { 
      ...
      path: '/1-pangeran-diponegoro/jadwal',
      description: 'Lihat jadwal pelajaran harian dan mingguan Kelas 1 Pangeran Diponegoro'
    },
    { 
      id: 'mata-pelajaran', 
      icon: BookOpen, 
      ...
      path: '/1-pangeran-diponegoro/mata-pelajaran',
    ...
    { 
      ...
      path: '/1-pangeran-diponegoro/daftar-hadir',
      description: 'Cek kehadiran siswa dan rekap absensi kelas secara real-time'
    },
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-amber-50 to-violet-50">
      {/* Navbar */}
          ...
          <div className="flex justify-between items-center h-20">
            <Link to="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
              <div className="relative">
                <div className="p-2 bg-gradient-to-r from-red-500 to-amber-500 rounded-xl">
                  <School className="w-6 h-6 text-white" />
                </div>
              </div>
              <span className="text-xl font-bold text-gray-700">
                Kelas 1 Pangeran Diponegoro
              </span>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              >
                ...
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-red-500 to-amber-500 transition-all duration-300 group-hover:w-full"></span>
              </Link>
              {menuItems.map((item) => (
                <Link
                  key={item.id}
      ...
      <div className="relative min-h-screen flex items-center justify-center pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            {/* Badge */}
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-red-100 to-amber-100 rounded-full text-red-700 text-sm font-medium mb-6">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-gray-700 mb-6 leading-tight">
              Selamat Datang di
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-amber-600 to-violet-600 animate-gradient">
                Kelas 1 Pangeran Diponegoro
              </span>
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-500 max-w-3xl mx-auto mb-10 leading-relaxed">
              Menjadi pahlawan masa depan dengan 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-amber-600 font-semibold"> semangat juang tinggi</span>
            </p>

            {/* Tombol Menu Utama */}
            <button
              onClick={scrollToMenu}
              className="group relative inline-flex items-center space-x-3 px-10 py-5 bg-gradient-to-r from-red-500 to-amber-500 text-white rounded-full font-semibold text-lg transition-all duration-300 hover:shadow-2xl hover:shadow-red-500/25 hover:-translate-y-1"
            >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-700 mb-4">
              Menu <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-amber-600">Utama</span>
            </h2>
            <p className="text-gray-400 text-lg">Akses fitur-fitur penting Kelas 1 Pangeran Diponegoro</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              <div className="p-2 bg-gradient-to-r from-red-500 to-amber-500 rounded-lg">
                <School className="w-5 h-5 text-white" />
              </div>
              <span className="text-gray-600 font-medium">Kelas 1 Pangeran Diponegoro</span>
            </div>
...
export default LandingPage1PDiponegoro;