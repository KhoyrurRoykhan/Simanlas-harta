...
const LandingPage2DrWahidin = () => {
  ...
  const menuItems = [
    { 
      ...
      path: '/2-dr-wahidin/jadwal',
      description: 'Lihat jadwal pelajaran harian dan mingguan Kelas 2 Dr. Wahidin'
    },
    { 
      id: 'mata-pelajaran', 
      icon: BookOpen, 
      ...
      path: '/2-dr-wahidin/mata-pelajaran',
    ...
    { 
      ...
      path: '/2-dr-wahidin/daftar-hadir',
      ...
      <div className="relative min-h-screen flex items-center justify-center pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            {/* Badge */}
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-100 to-cyan-100 rounded-full text-blue-700 text-sm font-medium mb-6">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-gray-700 mb-6 leading-tight">
              Selamat Datang di
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-cyan-600 to-sky-600 animate-gradient">
                Kelas 2 Dr. Wahidin
              </span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-500 max-w-3xl mx-auto mb-10 leading-relaxed">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-600 font-semibold"> menuju prestasi gemilang</span>
            </p>

            {/* Tombol Menu Utama */}
            <button
              onClick={scrollToMenu}
              className="group relative inline-flex items-center space-x-3 px-10 py-5 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-full font-semibold text-lg transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/25 hover:-translate-y-1"
            >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-700 mb-4">
              Menu <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-600">Utama</span>
            </h2>
            <p className="text-gray-400 text-lg">Akses fitur-fitur penting Kelas 2 Dr. Wahidin</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              ...
              <span className="text-gray-600 font-medium">Kelas 2 Dr. Wahidin</span>
            </div>
...
export default LandingPage2DrWahidin;