...
const LandingPage4TanMalaka = () => {
  ...
  const menuItems = [
    { 
      ...
      path: '/4-tan-malaka/jadwal',
      description: 'Lihat jadwal pelajaran harian dan mingguan Kelas 4 Tan Malaka'
    },
    { 
      id: 'mata-pelajaran', 
      icon: BookOpen, 
      ...
      path: '/4-tan-malaka/mata-pelajaran',
    ...
    { 
      ...
      path: '/4-tan-malaka/daftar-hadir',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-500 max-w-3xl mx-auto mb-10 leading-relaxed">
              Berpikir kritis dan 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-600 font-semibold"> membangun masa depan</span>
            </p>
      ...
      <div id="menu-section" className="relative py-20 px-4 sm:px-6 lg:px-8 scroll-mt-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">Akses fitur-fitur penting Kelas 4 Tan Malaka</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              ...
              <span className="text-gray-600 font-medium">Kelas 4 Tan Malaka</span>
            </div>
...
export default LandingPage4TanMalaka;